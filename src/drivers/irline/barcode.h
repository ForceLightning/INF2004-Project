...
typedef enum
{
    BARCODE_CHAR_0       = 0b000110100, ///< '0' character.
    BARCODE_CHAR_1       = 0b100100001, ///< '1' character.
    BARCODE_CHAR_2       = 0b001100001, ///< '2' character.
    BARCODE_CHAR_3       = 0b101100000, ///< '3' character.
    BARCODE_CHAR_4       = 0b000110001, ///< '4' character.
    BARCODE_CHAR_5       = 0b100110000, ///< '5' character.
    BARCODE_CHAR_6       = 0b001110000, ///< '6' character.
    BARCODE_CHAR_7       = 0b000100101, ///< '7' character.
    BARCODE_CHAR_8       = 0b100100100, ///< '8' character.
    BARCODE_CHAR_9       = 0b001100100, ///< '9' character.
    BARCODE_CHAR_A       = 0b100001001, ///< 'A' character.
    BARCODE_CHAR_B       = 0b001001001, ///< 'B' character.
    BARCODE_CHAR_C       = 0b101001000, ///< 'C' character.
    BARCODE_CHAR_D       = 0b000011001, ///< 'D' character.
    BARCODE_CHAR_E       = 0b100011000, ///< 'E' character.
    BARCODE_CHAR_F       = 0b001011000, ///< 'F' character.
    BARCODE_CHAR_G       = 0b000001101, ///< 'G' character.
    BARCODE_CHAR_H       = 0b100001100, ///< 'H' character.
    BARCODE_CHAR_I       = 0b001001100, ///< 'I' character.
    BARCODE_CHAR_J       = 0b000011100, ///< 'J' character.
    BARCODE_CHAR_K       = 0b100000011, ///< 'K' character.
    BARCODE_CHAR_L       = 0b001000011, ///< 'L' character.
    BARCODE_CHAR_M       = 0b101000010, ///< 'M' character.
    BARCODE_CHAR_N       = 0b000010011, ///< 'N' character.
    BARCODE_CHAR_O       = 0b100010010, ///< 'O' character.
    BARCODE_CHAR_P       = 0b001010010, ///< 'P' character.
    BARCODE_CHAR_Q       = 0b000000111, ///< 'Q' character.
    BARCODE_CHAR_R       = 0b100000110, ///< 'R' character.
    BARCODE_CHAR_S       = 0b001000110, ///< 'S' character.
    BARCODE_CHAR_T       = 0b000010110, ///< 'T' character.
    BARCODE_CHAR_U       = 0b110000001, ///< 'U' character.
    BARCODE_CHAR_V       = 0b011000001, ///< 'V' character.
    BARCODE_CHAR_W       = 0b111000000, ///< 'W' character.
    BARCODE_CHAR_X       = 0b010010001, ///< 'X' character.
    BARCODE_CHAR_Y       = 0b110010000, ///< 'Y' character.
    BARCODE_CHAR_Z       = 0b011010000, ///< 'Z' character.
    BARCODE_CHAR_DASH    = 0b010000101, ///< '-' character.
    BARCODE_CHAR_PERIOD  = 0b110000100, ///< '.' character.
    BARCODE_CHAR_SPACE   = 0b011000100, ///< ' ' (space) character.
    BARCODE_CHAR_DOLLAR  = 0b010101000, ///< '$' character.
    BARCODE_CHAR_SLASH   = 0b010100010, ///< '/' character.
    BARCODE_CHAR_PLUS    = 0b010001010, ///< '+' character.
    BARCODE_CHAR_PERCENT = 0b000101010, ///< '%' character.
    BARCODE_CHAR_ASTERISK
    = 0b010010100 ///< '*' character (used as a delimiter).
} barcode_char_t;
