...
#define MAGNETOMETER_ADDR 0x1E  // Default I2C address for the LSM303DLHC magnetometer
#define I2C_SDA_PIN 0
#define I2C_SCL_PIN 1
#define ACCELEROMETER_ADDR 0x19  // Default I2C address for the LSM303DLHC accelerometer
